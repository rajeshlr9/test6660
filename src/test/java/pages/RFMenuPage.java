...
public class RFMenuPage {
	...
	@FindBy(xpath = "//span[@value='Chg Task Grp']")   public static WebElement ChgTaskGrpBtn;
	...
	@FindBy(xpath="//div[@id='dataForm:brk1']/div[contains(text(),'EA')]") public WebElement suggestedQty1;

	//@FindBy(xpath="//*[@id='input1qtyQty51']") public WebElement taskQtyTxtBox;
	@FindBy(xpath="//div[@id='dataForm:brk1']/div/following::input[1]") public WebElement taskQtyTxtBox1;
	...
	@FindBy(xpath="//div[@id='dataForm:id_121']/div/following::input[1]") public WebElement taskQtyTextBox;
...
//						}
	...
	public void split_Move_iLPN_for_same_Item() throws Exception {
		...
		try {
			...
			//		+ iLPNz.get(1));
			Reporter.addStepLog(Steps.scenarioData.get("MoveLPNQty") + " qty is moved from LPN " + Items.getLpns(0) + " to "
					+ Items.getLpns(1));
			homepage.userClosesOpenedwindow("RF Menu");
		} catch (Exception e) {
			Steps.testRes = "Failed";
			...
			case "MM3 Ptwy CASE":
				...
				for (int i = 0; i < Items.getLpnsLength(); i++) {	
					...
					//else if(SeleniumTestHelper.isElementDisplayed(RLoc)) {
						...
						Steps.logger.info("Putaway Completed. iLPN "+ Items.getLpns(i)+ " moved to "+Items.getupdtLoc()+" location");
						Reporter.addStepLog("Putaway Completed. iLPN "+ Items.getLpns(i)+ " moved to "+Items.getupdtLoc()+" location");
			...
			case "MM3 QSC Ptwy Bulk":
				...
				for (int i = 0; i < Items.getLpnsLength(); i++) {	
					...
					if(sugLOC.size()>0) {
						...
						putawayLoctxtBox.sendKeys(Keys.ENTER);
						Screenshots.captureSnapshot(driver);
						Steps.logger.info("Bulk Putaway Completed. Item moved to:"+sysSuggestedLocSplit[1]+" location");
						Reporter.addStepLog("Bulk Putaway Completed. Item moved to:"+sysSuggestedLocSplit[1]+" location");
					}
					else if(RLOC.size()>0) {
						...
						Screenshots.captureSnapshot(driver);
						//Steps.logger.info("Bulk Putaway Completed. iLPN "+ iLPNz.get(i)+ " moved to "+sysSuggestedLocSplit[1]+" location");
						//Reporter.addStepLog("Bulk Putaway Completed. iLPN "+ iLPNz.get(i)+ " moved to "+sysSuggestedLocSplit[1]+" location");
						Steps.logger.info("Bulk Putaway Completed. iLPN "+ Items.getLpns(i)+ " moved to "+sysSuggestedLocSplit[1]+" location");
...
//					confirmlocation_Input.click();
					...
					Thread.sleep(3000);
					//SeleniumTestHelper.waitForElementToBeDisplayed(driver, AcceptProceedForTote, 50);

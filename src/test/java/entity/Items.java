...
public class Items {
	...
	public static void setAsnNumber2(String asnNumber2) {
		Items.asnNumber2 = asnNumber2;
	}
	...
	public static String getilpnSerialNumbers(int i) {
		return ilpnSerialNumbers.get(i);
	}

...
@DailyRegression_NVI @NVI_IB001 @NVI_InBoundScenario @NVI_EDIOrderReceiving
...
@DailyRegression_NVI @NVI_IB002 @NVI_InBoundScenario @NVI_EDIOrderReceiving
...
@DailyRegression_NVI @NVI_IB003 @NVI_InBoundScenario @NVI_Rec&Putaway
...
@DailyRegression_NVI @NVI_IB004 @NVI_InBoundScenario @NVI_Rec&Putaway
...
@DailyRegression_NVI @NVI_IB005 @NVI_InBoundScenario @NVI_BlindReceipt
...
@DailyRegression_NVI @NVI_IB006 @NVI_InBoundScenario @NVI_PartiallyVerified
...
@DailyRegression_NVI @NVI_IB007 @NVI_InBoundScenario @NVI_PartiallyVerified
...
@DailyRegression_NVI @NVI_IB008 @NVI_InBoundScenario @NVI_Rec&Putaway
...
@DailyRegression_NVI_Manual @NVI_IB009 @NVI_InBoundScenario @NVI_BlindRec&Putaway
...
@DailyRegression_NVI_Manual @NVI_IB010 @NVI_InBoundScenario @NVI_RecDamage&Putaway
...
@DailyRegression_NVI_Manual @NVI_IB011 @NVI_InBoundScenario @NVI_LoadASNUsingKelli
...
@DailyRegression_NVI @NVI_OB001 @NVI_OutBoundScenario @NVI_SingleLineSerParcelDO
...
@DailyRegression_NVI @NVI_OB002 @NVI_OutBoundScenario @NVI_SingleLineLTLDO
...
@DailyRegression_NVI @NVI_OB003 @NVI_OutBoundScenario @NVI_MultiLineNonSerParcelDO
...
@DailyRegression_NVI @NVI_OB004 @NVI_OutBoundScenario @NVI_SingleLineNonSerParcelDO
...
@DailyRegression_NVI @NVI_OB005 @NVI_OutBoundScenario @NVI_MultiLineNonSerLTLDO
...
@DailyRegression_NVI @NVI_OB006 @NVI_OutBoundScenario @NVI_SingleLineCancelDO
Scenario: Distribution Order creation - Single Line LTL FDFE LTLE 
	Given I have excel data 
		| NVI_OBScenario006 |
	And Open the chrome browser by selenium 
